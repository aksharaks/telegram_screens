  ...
  final List<Map<String, String>> users = [
   ...
   // Call icon needed
    ...
    },
    {
      ...
      'profilePicture':
          'https://cdn.prod.website-files.com/619e8d2e8bd4838a9340a810/647c1064ebf1c6171bfd3a87_profile-picture-feature-1.webp',
          'callDate': '13/16',
    },
    {
      'name': 'Arjun',
    ...
    {
      'name': 'Alexa',
      'lastMessage': 'incoming(2min)',
      'profilePicture':
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSjX0KvjIzlCA7Mtu1bhyEmmG3I_N2vG0znSSDgpUvMoXFuuU9E5QYRxVS4f8sEoy-kD-E&usqp=CAU',
'callDate': '9/10',
    ...
    },
    {
      ...
      'profilePicture':
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSLxwuEP1dItZwtEtr--OBzW-Z7JRvf3jYmdg&s',
          'callDate': '13/15',
    },
    {
      'name': 'Anna',
     ...
     body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            ,style: TextStyle(color: user['lastMessage'] == 'missed' ? Colors.red : Colors.black,
            ),
                      ),
            
            subtitle: Text(user['lastMessage']!,style: TextStyle(fontSize: 12, color: Color.fromARGB(255, 94, 90, 90)),
                      ),
             trailing: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Text(users[index]['callDate']!,style: TextStyle(fontSize: 13, color: Colors.black),
                      ),
                const SizedBox(width: 2), // space between date and error icon
                IconButton(
